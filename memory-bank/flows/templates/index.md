...
- [FT-XXX: Feature Brief](feature/brief.md) — compact problem formalization for the **large** feature path only. Answers: how to capture context, problem, success sketch, and open questions before canonical IDs in `feature.md`.
